...
export const metadata: Metadata = {
  title: "Next.js Profile | ModernAdmin - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for ModernAdmin - Next.js Tailwind CSS Admin Dashboard Template",
};
